...
// Content Management
use App\Http\Controllers\Customer\SalesProcess\{AddressController,CartController , PaymentController as CustomerPaymentController};
...
use App\Http\Controllers\Admin\Notify\{EmailController,EmailFileController,SMSController};

// Auth Customer

use App\Http\Controllers\Admin\User\{AdminUserController,CustomerController,RoleController ,PermissionController};

// Customer/market
use App\Http\Controllers\Admin\Ticket\{TicketCategoryController,TicketPriorityController,TicketAdminController,TicketController};
use App\Http\Controllers\Admin\Content\{CategoryController as ContentCategoryController , CommentController as ContentCommentController ,FAQController , MenuController ,PageController ,PostController ,BannerController};
use App\Http\Controllers\Admin\Market\{BrandController,StoreController,GuaranteeController,PropertyController,PropertyValueController,CategoryController,ProductColorController,GalleryController,CommentController,DeliveryController,DiscountController,OrderController,PaymentController,ProductController};
...
Route::prefix('SalesProcess')->group(function(){
    ...
    ->name('customer.sales-process.address-and-delivery');
...
Route::prefix('Market')->controller(MarketProductController::class)->group(function () {
