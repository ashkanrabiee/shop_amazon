        ...
        <div>
            <div class="col-lg-8 col-md-8 col-xs-12 pull-right">
                <div class="header-right">
                    <div class="logo">
                        <a href="#"><img src="{{asset('customer-assets/images/logo.png')}}" alt="logo"></a>
                    </div>
                    ...
                    <div class="col-lg-8 col-md-12 col-xs-12 pull-right">
                        <div class="search-header search-box">
                            <form action="#">
                                ...
                                <button class="btn-search" type="submit"><img src="{{asset('customer-assets/images/search.png')}}"
                                        alt="search"></button>
                            </form>
                            <div class="search-result">
                                ...
                                <div class="search-results-list js-search-ad-banner">
                                    <a href="#">
                                        <img src="{{asset('customer-assets/images/banner-search.jpg')}}" alt="banner-search">
                                    </a>
                                </div>
                            </div>
                        </div>
                ...
                <li class="item-list-menu megamenu-1 nav-overlay"><a href="#" class="list-category first after"
                    ...
                    <ul class="list-menu-level-2 list-menu-discounts-offers">
                        ...
                        <li class="discounts-offers-list-item main-banner">
                            <a href="#">
                                <img src="{{asset('customer-assets/images/banner.jpg')}}" alt="banner">
                            </a>
                        </li>
                    </ul>
                </li>
